...
spacingDiameter <- read_excel(path="./RawData/2020pumpkinData.xlsx", sheet="Spacing Diameter")
...
# Read sheet with DIAMETERS, transform from wide to tall, remove NA records
spacingDiameter <- read_excel(path="./RawData/2021pumpkinData.xlsx", sheet="Spacing Diameters (inches)")
