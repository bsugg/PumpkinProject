...
# make a scatter plot
ggplot(pumpkinsDiaRoundTablePlot,aes(x=diameterRoundUp,y=PumpkinAvgCount,color=spacingDim)) + geom_point()
# make a connected line plot
ggplot(pumpkinsDiaRoundTablePlot,aes(x=diameterRoundUp,y=PumpkinAvgCount,group=spacingDim,color=inRow)) + geom_line(size=3) + geom_point()
