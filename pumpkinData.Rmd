...
spacingWeight <- mutate(spacingWeight,pumpkinID=paste0(plot,"-",pumpkinNum))
...
spacingLength <- mutate(spacingLength,pumpkinID=paste0(plot,"-",pumpkinNum))
...
# Create unique identifier for each pumpkin and assign crop year
spacingDiameter <- mutate(spacingDiameter,pumpkinID=paste0(plot,"-",pumpkinNum))
...
spacingData <- select(spacingData,c(11,10,1,3,2,8,6,15,4,5,16,14,9,12,13))
